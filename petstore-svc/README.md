...
- API version: 1.0.0
- Build date: 2024-02-18T15:32:56.913002+01:00[Europe/Berlin]



This autogenerated project defines an API crate `petstore-svc` which contains:
...
#[async_trait]
impl petstore-svc::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = petstore-svc::server::new(Arc::new(ServerImpl));
