...
- API version: 1.0.0
- Build date: 2024-02-19T23:06:57.780407+01:00[Europe/Berlin]



This autogenerated project defines an API crate `petstore-db-svc` which contains:
...
#[async_trait]
impl petstore-db-svc::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = petstore-db-svc::server::new(Arc::new(ServerImpl));
